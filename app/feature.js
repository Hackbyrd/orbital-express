...
function actionIndexFileText({ upperName, lowerName, pascalName, camelName }) { return `/**\n * ${upperName} ACTION\n *\n * Aggregates all action method files to be exported here\n */\n\n'use strict';\n\nmodule.exports = {\n  ...require('./V1Example')\n}\n`; }
